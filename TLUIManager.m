...
//    TLFriendDetailViewController *detailVC = [[TLFriendDetailViewController alloc] init];
    ...
    UserProfileViewController * detailVC = [storyboard instantiateViewControllerWithIdentifier:@"UserProfileVC"];
    
    PFQuery * query = [PFUser query];
    [query getObjectInBackgroundWithId:user.userID block:^(PFObject * _Nullable object, NSError * _Nullable error) {
       
        if (object) {
            detailVC.user = (PFUser*)object;
